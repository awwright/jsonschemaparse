...
var validationTestFiles = [
	...
	// 'draft7/optional/format/date-time.json',
	// 'draft7/optional/format/date.json',
	// 'draft7/optional/format/email.json',
	// 'draft7/optional/format/hostname.json',
	// 'draft7/optional/format/idn-email.json',
	// 'draft7/optional/format/idn-hostname.json',
	// 'draft7/optional/format/ipv4.json',
	// 'draft7/optional/format/ipv6.json',
	// 'draft7/optional/format/iri-reference.json',
	// 'draft7/optional/format/iri.json',
	// 'draft7/optional/format/json-pointer.json',
	// 'draft7/optional/format/regex.json',
	...
	// 'draft7/optional/format/uri-template.json',
